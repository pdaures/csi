...
SELECT FIRST_NAME, LAST_NAME, COUNTRY FROM USERS WHERE USER_ID='bobama'; [42102-191]
	...
	com.pdaures.csi.dao.AccountDao.getUserAccount(AccountDao.java:31)
	com.pdaures.csi.service.AccountServiceImpl.findAccount(AccountServiceImpl.java:27)
	com.pdaures.csi.controller.AccountOverviewController.accountOverview(AccountOverviewController.java:28)
...
SELECT FIRST_NAME, LAST_NAME, COUNTRY FROM USERS WHERE USER_ID='bobama'; [42102-191]
	...
	org.h2.jdbc.JdbcStatement.executeQuery(JdbcStatement.java:73)
